        ...
        try {
            ...
            if (product) {
                setFormData({
                    ...
                    mainPrice: String(product.mainPrice || ''),
                ...
                if (product.imageUrl) {
                    setImagePreview(product.imageUrl.url);
                }
            } else {
        ...
        <div className="max-w-5xl mx-auto">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Update your medicine or healthcare product details</p>
                </div>
                <button
