                ...
                <form className="space-y-8" onSubmit={handleSubmit}>
                    ...
                    <div className="pt-4">
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full flex items-center justify-center gap-3 py-5 ${formData.role === 'host' ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-blue-600 hover:bg-blue-700'} text-white font-black text-xs uppercase tracking-[0.2em] rounded-2xl shadow-xl transition-all duration-300 group`}
                        >
                            {isLoading ? (
